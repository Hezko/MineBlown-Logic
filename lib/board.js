...
var log = log4js.getLogger("Board");
...
class Board {
	...
	discover(y, x) {
		...
		log.debug("discovering for y=" + y + ", x=" + x + ", totalSquares=" + this.totalSquares + ", discoveredSquares=" + this.isDiscovered);
		let newlyDiscovered = [];
		square = this.recursiveDiscover(square, newlyDiscovered);
		log.debug("discovered for y=" + y + ", x=" + x + ", totalSquares=" + this.totalSquares + ", discoveredSquares=" + this.isDiscovered);
